            ...
            <div className="benefit_component">
              <div className="benefit_wrapper">
                <div className="benefit_content">
                  <h2>Skyhouse Alam Sutera, Makes Everything Better</h2>
            ...
            <div className="project-carousel">
              {filteredProjects.length > 0 ? (
                ...
                <div className="project-empty-state">
                  ...
                  <p>There are currently no {activeTab === 'available' ? 'available' : 'built'} projects to display.</p>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="container-large">
          <div className="padding-section-large">
            <div className="character_component">
              <h2>Meet the Characters in Every Skyhouse Projects</h2>
          ...
          <div className="cta_component">
            <div className="cta_left">
              <div className="cta_card">
                <h2>Get in touch with us to discover more about Skyhouse!</h2>
      ...
      <div className="padding-global">
        <div className="container-large">
          ...
          <div className="footer_bottom">
            <p>© 2025 Skyhouse Alamsutera. All rights reserved.</p>
