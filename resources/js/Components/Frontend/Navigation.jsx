        ...
        <div className="navbar_container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'relative' }}>
          ...
          >
            <div className={`menu-icon2 ${isMobileMenuOpen ? 'is-open' : ''}`}>
              <div className="menu-icon2_line-top" style={{ backgroundColor: 'white', transition: 'background-color 0.3s ease-in-out' }}></div>
              <div className="menu-icon2_line-middle">
                <div className="menu-icon_line-middle-inner" style={{ backgroundColor: 'white', transition: 'background-color 0.3s ease-in-out' }}></div>
              </div>
              <div className="menu-icon2_line-bottom" style={{ backgroundColor: 'white', transition: 'background-color 0.3s ease-in-out' }}></div>
            </div>
          </button>
        </div>
      </nav>
