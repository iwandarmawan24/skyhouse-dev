          ...
          <div className="footer_content">
            ...
            <div className="footer_section">
              ...
              <div className="footer_social">
                {socialLinks.filter(s => s.url).map((item) => (
