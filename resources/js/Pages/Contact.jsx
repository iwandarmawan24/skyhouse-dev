            ...
            <div className="contact-container">
              ...
              <div className="contact-form-wrapper">
                <div className="contact-form-sticky">
                  ...
                  <form onSubmit={handleSubmit} className="contact-form">
                    ...
                    <div className="form-group">
                      ...
                      <div className="form-row">
                        ...
                        >
                          ...
                          <option value="kinary">Kinary House</option>
                    ...
                    <button type="submit" className="button is-contact-submit">
                      Submit
                    </button>
                  </form>
                </div>
              ...
              <div className="contact-info-wrapper">
                ...
                <div className="contact-details">
                  ...
                  <div className="contact-detail-section">
                    ...
                    <div className="contact-detail-content">
                      ...
                      <p>Jl. Alamsutera Boulevard No.88, Pakulonan Barat, Kelapa Dua, Tangerang, Banten 15810</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="faq-section">
                  ...
                  <p className="faq-subtitle">Have some questions bubbling up? Take a peek below for all the deets you're curious about!</p>
