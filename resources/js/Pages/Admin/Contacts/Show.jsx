                ...
                <div className="p-6 space-y-6">
                    ...
                    {contact.product && (
                        <div className="border-t pt-6">
                            <label className="block text-sm font-medium text-gray-500 mb-3">Interested Property</label>
                            <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
                                {contact.product.images && contact.product.images.length > 0 && (
                                    <img
                                        src={
                                            contact.product.images[0].image_path.startsWith('http')
                                                ? contact.product.images[0].image_path
                                                : `/storage/${contact.product.images[0].image_path}`
                                        }
                    ...
                    <div className="border-t pt-6 flex items-center gap-4">
                        <a
                            href={`mailto:${contact.email}?subject=Re: Your inquiry about ${
                                contact.product ? contact.product.name : 'SkyHouse Property'
                            }`}
